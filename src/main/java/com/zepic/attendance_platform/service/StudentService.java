...
public class StudentService {
    ...
    public StudentService(StudentRepository studentRepository, DepartmentRepository departmentRepository,
                          CollegeRepository collegeRepository, AppUserRepository appUserRepository, StudentMapper studentMapper) {
    ...
    public PagedResponse<StudentResponse> listStudents(AuthenticatedUser authUser, String search, Pageable pageable)
        ...
        if (search != null && !search.isBlank()) {
            studentsPage = studentRepository.searchByCollegeId(collegeId, search, pageable);
        } else {
            studentsPage = studentRepository.findByCollege_Id(collegeId, pageable);
        }
    ...
    @Transactional(readOnly = true)
    public StudentResponse getStudentById(AuthenticatedUser authUser, Long studentId)
            throws AuthenticationRequiredException,
            TeacherRoleRequiredException,
    ...
    @Transactional
    public StudentResponse createStudent(AuthenticatedUser authUser, CreateStudentRequest request)
            throws AuthenticationRequiredException,
            TeacherRoleRequiredException,
        ...
        Department department = departmentRepository
                .findByIdAndCollege_Id(request.getDepartmentId(), collegeId)
                .orElseThrow(DepartmentNotFoundException::new);
        if (studentRepository.existsByCollege_IdAndRollNumber(collegeId, request.getRollNumber())) {
    ...
    private AppUser requireTeacher(
        ...
        AppUser user = appUserRepository
                .findByIdAndCollege_Id(authUser.userId(), collegeId)
                .orElseThrow(
